...
var _assignIn = __webpack_require__(22);
...
var _cloneDeep2 = __webpack_require__(127);

var _cloneDeep3 = _interopRequireDefault(_cloneDeep2);

var _noop = __webpack_require__(128);
...
var DEFAULT_SETTINGS = {
	...
	onCollision: _noop2.default,
	onCollisionFix: _noop2.default,
	onCollisionFail: _noop2.default,
	offsets: {
		vertical: 0,
		horizontal: 0
	},
...
var Positioner = function () {
	function Positioner(anchor, vessel, settings) {
		...
		this._settings = (0, _assignIn2.default)({}, DEFAULT_SETTINGS, settings);
   ...
   */
		...
		value: function _invertAdjustments(adjustments, direction) {
			var _cloneDeep = (0, _cloneDeep3.default)(adjustments),
			    anchorAdjustment = _cloneDeep.anchorAdjustment,
			    vesselAdjustment = _cloneDeep.vesselAdjustment;
			...
			return { anchorAdjustment: anchorAdjustment, vesselAdjustment: vesselAdjustment };
		}
   ...
   */
		...
		value: function _adjustOffsets(offsets, adjustments) {
			offsets = (0, _cloneDeep3.default)(offsets);
   ...
   */
		...
		value: function _getNewOffsets(offsets, placement) {
			var newVesselOffsets = (0, _cloneDeep3.default)(offsets.anchor);
   ...
   */
		...
		key: '_updatePosition',
		value: function _updatePosition(newOffsets) {
			var _newOffsets$vessel = newOffsets.vessel,
			    left = _newOffsets$vessel.left,
			    top = _newOffsets$vessel.top;
   ...
   */
		...
		value: function detectCollisions(offsets) {
			var anchorOffsets = offsets.anchor,
			    containerOffsets = offsets.collisionContainer,
			    vesselOffsets = offsets.vessel;


			if (!containerOffsets || anchorOffsets.top > containerOffsets.bottom || anchorOffsets.right < containerOffsets.left || anchorOffsets.bottom < containerOffsets.top || anchorOffsets.left > containerOffsets.right) {
				return;
			}
   ...
   */
		...
		value: function fixCollisions(offsets, collisions, collisionStrategy) {
			...
			var adjustedCollisionStrategy = (0, _clone2.default)(collisionStrategy);
   ...
   */
		...
		get: function get() {
			...
			this._adjustments = {
				anchorAdjustment: (0, _assignIn2.default)({}, DEFAULT_ADJUSTMENT, this._settings.anchorAdjustment),
				vesselAdjustment: (0, _assignIn2.default)({}, DEFAULT_ADJUSTMENT, this._settings.vesselAdjustment)
			};
...
var _autoPositioner = __webpack_require__(129);
...
var AutoPositioner = function (_Positioner) {
	...
	function AutoPositioner(anchor, vessel, settings) {
		...
		_this._settings = (0, _assignIn2.default)({}, DEFAULT_SETTINGS, _this._settings);
  ...
  */
   ...
   */
		...
		value: function _watchWithEvents(callback) {
			...
			var debouncedHandler = (0, _debounce2.default)(handler, watchStrategy.delay || 15);
